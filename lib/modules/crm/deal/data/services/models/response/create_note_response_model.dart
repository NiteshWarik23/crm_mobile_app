...
sealed class CreateNoteResponseModel {}

class CreateNoteSuccessResponseModel extends CreateNoteResponseModel{
  Message? message;

  CreateNoteSuccessResponseModel({this.message});

  CreateNoteSuccessResponseModel.fromJson(Map<String, dynamic> json) {
    message =
...
class CreateNoteErrorResponseModel extends CreateNoteResponseModel{
  String? exception;
  String? excType;
  String? exc;
  String? sServerMessages;

  CreateNoteErrorResponseModel(
      {this.exception, this.excType, this.exc, this.sServerMessages});

  CreateNoteErrorResponseModel.fromJson(Map<String, dynamic> json) {
