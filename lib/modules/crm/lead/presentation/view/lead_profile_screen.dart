...
import 'package:crm_mobile_app/modules/crm/lead/presentation/widgets/view_notes_widget.dart';
    ...
    return Column(
      ...
      children: [
        ...
        _buildTaskButton("assets/icons/note.svg", 'Add Note', Icons.add,
          ...
          showViewNotesBottomSheet(context, leadID ?? '');
        }),
        _buildTaskButton(
