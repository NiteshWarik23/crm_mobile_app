...
class LeadRepositoryImpl implements LeadRepository {
  ...
  @override
  ResultFuture<CreateNoteResponseModel> createNote(
      CreateNoteRequestModel createNoteRequestModel) async {
    try {
      final createNoteRespone =
  ...
  @override
  ResultFuture<GetNotesResponseModel> getNotes(
    ...
    try {
      ...
      } else if (getNotesResponse is GetNotesErrorResponseModel) {
        return DataFailed(ServerFailure(
            //TODO TBD for what message to show
            //leadResponse.exc ??
            Strings.defaultErrMsg,
