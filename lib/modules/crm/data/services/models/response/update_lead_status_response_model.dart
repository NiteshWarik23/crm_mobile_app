...
sealed class UpdateLeadStatusResponse {}


class UpdateLeadStatusResponseModel extends UpdateLeadStatusResponse {
  Message? message;

  UpdateLeadStatusResponseModel({this.message});

  UpdateLeadStatusResponseModel.fromJson(Map<String, dynamic> json) {
    message =
...
class UpdateLeadStatusErrorResponseModel extends UpdateLeadStatusResponse {
  String? excType;
  String? sServerMessages;

  UpdateLeadStatusErrorResponseModel({this.excType, this.sServerMessages});

  UpdateLeadStatusErrorResponseModel.fromJson(Map<String, dynamic> json) {
