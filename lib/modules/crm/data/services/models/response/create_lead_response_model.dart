sealed class CreateLeadResponseModel {}

class CreateLeadSuccessResponseModel extends CreateLeadResponseModel{
  CreateLeadData? data;

  CreateLeadSuccessResponseModel({this.data});

  CreateLeadSuccessResponseModel.fromJson(Map<String, dynamic> json) {
...
class CreateLeadErrorResponseModel extends CreateLeadResponseModel {
  String? exception;
  String? excType;
  String? exc;

  CreateLeadErrorResponseModel({this.exception, this.excType, this.exc});

  CreateLeadErrorResponseModel.fromJson(Map<String, dynamic> json) {
