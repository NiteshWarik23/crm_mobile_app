...
class BarChartSample4 extends StatefulWidget {
  ...
  final Color dark = Colors.lightGreenAccent.shade700;
  final Color normal = Colors.lightGreenAccent.shade400;
  final Color light = Colors.lightGreenAccent.shade100;
...
class BarChartSample4State extends State<BarChartSample4> {
  Widget bottomTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 0:
        text = 'assets/icons/instagram.png';
        break;
      case 1:
        text = 'assets/icons/facebook.png';
        break;
      case 2:
        text = 'assets/icons/whatsapp.png';
        break;
      case 3:
        text = 'assets/icons/linkedin.png';
        break;
      case 4:
        text = 'assets/icons/pinterest.png';
        break;
      default:
        text = '';
        break;
      ...
      child: Padding(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            final barsSpace = 4.0 * constraints.maxWidth / 70;
...
int touchedIndex = -1; // Store the currently touched index
